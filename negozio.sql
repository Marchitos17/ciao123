...
--
-- Host: 127.0.0.1
-- Creato il: Mar 18, 2024 alle 22:37
...
CREATE TABLE `ordini` (
  ...
  `num_ordine` varchar(255) NOT NULL,
  `status_ordine` varchar(255) NOT NULL,
  `cur_ordine` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `ordini` (`id_ordine`, `importo_ordine`, `num_ordine`, `status_ordine`, `cur_ordine`) VALUES
(1, 56, 'EUR', '123456', 'Completed');
...
--
ALTER TABLE `rapporti`
  MODIFY `id_rapporto` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
